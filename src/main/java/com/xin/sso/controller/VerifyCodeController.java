...
public class VerifyCodeController extends HttpServlet {
    ...
    public void verifyCode(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        // 将图像填充为白色
        g.setColor(new Color(randomInt(100, 255),randomInt(100, 255),randomInt(100, 255)));
    ...
    public void initxuan() throws Exception {
        // 宽度
        String strWidth = "90";
        // 高度
        String strHeight = "30";
